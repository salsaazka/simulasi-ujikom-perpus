      ...
      <div class="page-header min-vh-100">
        <div class="container">
          ...
          background-size: cover;">
                ...
                <div class="position-relative bg-gradient-white h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden">
                  <img src="{{asset('assets/img/login.png')}}" alt="" class="w-100">
